...
### Q3: GitHub Copilot CLIやCursorと何が違いますか？

**A**: 実行環境と機能範囲が異なります。

#### CLI型の比較

| 機能 | Claude Code | GitHub Copilot CLI | Gemini CLI |
|------|-------------|-------------------|-----------|
...
**注意**: GitHub CopilotにはIDE版（エディタ内コード補完）とCLI版（ターミナルAIアシスタント）があります。ここではCLI版と比較しています。

詳細な比較は [01_tools_comparison.md](./01_tools_comparison.md) を参照してください。
